                ...
                <div class="row">
                    ...
                    @if ($disenio->detallePedido->pedidos->estado === 'disenio' && $disenio->url_disenio != '')
                        <div class="col-6">
                            ...
                            <br>
                            <h5>Nombre del producto: {{ $disenio->detallePedido->producto->name }}</h5>
                            ...
                            <img src="{{ $disenio->url_disenio }}" class="card-img-top img-fluid" alt="Diseño del producto">
                        ...
                        <div class="col-6">
                            <div class="container mt-5">
                                ...
                                <form action="{{ route('respuestas.store') }}" method="post">
                                    @csrf
                                    <input type="hidden" class="form-control" aria-describedby="textHelp" name="disenio_id"
                                        value="{{ $disenio->id }}" readonly>
